...
describe('insert', () => {
    ...
    it('should insert sets of unordered and unique values', () => {
        const testValues = [
            [
                7630, 4561, 8976, 8612, 6374, 6755, 5845, 2212, 6786, 6919, 514, 6840, 6204, 6965,
                9040, 6000, 1268, 6785, 4513, 4533,
            ],
            [
                1145, 7598, 6041, 2882, 6917, 121, 5920, 6546, 7369, 1033, 1399, 2233, 8347, 2413,
                6758, 7634, 9896, 4177, 721, 468,
            ],
            [
                1239, 1884, 121, 6623, 7147, 349, 8605, 4046, 9592, 1317, 8859, 8922, 369, 5502,
                6383, 1084, 1941, 5604, 7514, 8365,
            ],
            [
                1239, 1884, 121, 6623, 7147, 349, 8605, 4046, 9592, 1317, 8859, 8922, 369, 5502,
                6383, 1084, 1941, 5604, 7514, 8365,
            ...
            [
                4113, 723, 8504, 4718, 9810, 8671, 6115, 4698, 3805, 1491, 2792, 9920, 4904, 3740,
                9465, 5581, 4862, 6840, 4083, 637,
            ],
            [
                2250, 849, 7716, 6939, 6520, 6285, 6720, 4062, 3052, 8125, 4770, 2322, 5300, 9753,
                7434, 1885, 878, 9812, 5904, 7362,
            ],
        ];
